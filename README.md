...
- 2026-09-05: `AGENTS.md` を追加（構成・コマンド・デプロイ規約を記録）
- 2026-09-05: サイト全体をポリッシュ（絵文字→SVG化、a11y/SEO強化、UI洗練）
- 2026-09-05: README に作成クレジットを追記
- 2026-09-05: 浜名湖うなぎ紹介サイトを構築（GitHub Pages 対応）
